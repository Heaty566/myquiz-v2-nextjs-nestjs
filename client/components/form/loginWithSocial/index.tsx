...
export const LoginWithSocial: React.FunctionComponent<LoginWithSocialProps> = () => {
        return (
                <LoginWithContainer>
                        <LoginWithSocialItem as="a" href={`${process.env.SERVER_URL}/auth/google`}>
                                <Image src="/asset/icon/google.svg" height="16" width="16" alt="google" />
                                <Text as="p" $type="h4">
                                        Continue with Google
                                </Text>
                        </LoginWithSocialItem>
                        <LoginWithSocialItem as="a" href={`${process.env.SERVER_URL}/auth/facebook`}>
                                <Image src="/asset/icon/facebook.svg" height="16" width="16" alt="facebook" />
                                <Text as="p" $type="h4">
                                        Continue with Facebook
                                </Text>
                        </LoginWithSocialItem>
                        <LoginWithSocialItem as="a" href={`${process.env.SERVER_URL}/auth/github`}>
